...
<div class="app-content-header">
  <div class="container-fluid d-flex justify-content-between align-items-center">
    <div>
      <h3 class="fw-bold mb-0"><i class="bi bi-calendar-check text-primary me-2"></i>Antrian Temu Dokter</h3>
      <p class="small text-muted mb-0">Kelola seluruh antrian temu dokter hari ini.</p>
    </div>
    <a href="{{ route('admin.temu.create') }}" class="btn btn-primary rounded-pill">+ Tambah Antrian</a>
  </div>
</div>
...
<div class="app-content">
  <div class="container-fluid">
    ...
    {{-- Filter --}}
    <div class="mb-3">
      <a href="{{ route('admin.temu', ['filter' => 'today']) }}" class="btn btn-sm {{ $filter=='today'?'btn-primary':'btn-outline-primary' }}">Hari Ini</a>
      <a href="{{ route('admin.temu', ['filter' => 'all']) }}" class="btn btn-sm {{ $filter=='all'?'btn-primary':'btn-outline-primary' }}">Semua</a>
    </div>
