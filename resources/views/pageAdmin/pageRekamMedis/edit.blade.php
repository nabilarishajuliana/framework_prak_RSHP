  ...
  <div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
      <div class="card-body">
        ...
        <form action="{{ route('admin.rekammedis.update', $rekam->idrekam_medis) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="d-flex justify-content-end gap-2 mt-4">
            <a href="{{ route('admin.rekammedis') }}" class="btn btn-outline-secondary rounded-pill px-4">
              Batal
            </a>
