...
<div class="container py-4">
    <h2 class="fw-bold mb-4 text-dark">Tambah Ras Hewan Baru</h2>

    <form action="{{ route('admin.ras.hewan.store') }}" method="POST" class="card p-4 shadow-sm border-0">
        @csrf

        <div class="mb-3">
            <label class="form-label">Nama Ras Hewan</label>
            <input type="text" name="nama_ras" class="form-control @error('nama_ras') is-invalid @enderror" placeholder="Masukkan nama ras" required>
