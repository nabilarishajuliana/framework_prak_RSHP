...
<body><?php include("../Navbar.php"); ?>
    <div class="container">
        <div class="header">
            <h1>Edit Kategori</h1><a class="btn secondary" href="readKategori.php">Kembali</a>
        </div>
        ...
        <form class="card" method="POST" action="">
            <div class="form-row">
                <div class="field">
                    ...
                    <input class="input" type="text" id="nama_kategori" name="nama_kategori" value="<?= htmlspecialchars($data['nama_kategori']) ?>" required>
                </div>
            </div>
